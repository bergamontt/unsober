...
class TeacherSystemTest extends BaseSystemTest {
    ...
    @Test
    void getAllAsAdminShouldReturnAllTeachers() throws Exception {
    ...
    @Test
    void getAllAsStudentShouldReturnAllTeachers() throws Exception {
        Teacher saved = teacherRepository.save(teacher());
        TeacherResponseDto expectedDto = responseMapper.toDto(saved);
        ResultActions result = mvc.perform(get("/teacher")
                .header("Authorization", "Bearer " + studentToken)
    ...
    @Test
    void getByIdAdminShouldReturnTeacher() throws Exception {
        Teacher saved = teacherRepository.save(teacher());
        TeacherResponseDto expectedDto = responseMapper.toDto(saved);
    ...
    @Test
    void getByIdAsStudentShouldReturnTeacher() throws Exception {
        Teacher saved = teacherRepository.save(teacher());
        TeacherResponseDto expectedDto = responseMapper.toDto(saved);
        ResultActions result = mvc.perform(get("/teacher/{id}", saved.getId())
                .header("Authorization", "Bearer " + studentToken)
