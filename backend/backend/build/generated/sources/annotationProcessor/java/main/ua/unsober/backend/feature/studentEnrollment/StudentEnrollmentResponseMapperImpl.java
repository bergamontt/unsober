...
@Component
public class StudentEnrollmentResponseMapperImpl implements StudentEnrollmentResponseMapper {

    @Override
    public StudentEnrollmentResponseDto toDto(StudentEnrollment enrollment) {
        if ( enrollment == null ) {
            return null;
        }
        ...
        studentEnrollmentResponseDto.id( enrollment.getId() );
        studentEnrollmentResponseDto.student( studentToStudentResponseDto( enrollment.getStudent() ) );
        studentEnrollmentResponseDto.course( courseToCourseResponseDto( enrollment.getCourse() ) );
        studentEnrollmentResponseDto.status( enrollment.getStatus() );
        studentEnrollmentResponseDto.enrollmentYear( enrollment.getEnrollmentYear() );
        studentEnrollmentResponseDto.createdAt( enrollment.getCreatedAt() );
